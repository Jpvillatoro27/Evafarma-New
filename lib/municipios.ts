// Lista completa de los 340 municipios de Guatemala organizados por departamento
export const municipiosPorDepartamento: Record<string, string[]> = {
  ...
  'Chimaltenango': [
    ...
    'Parramos', 'Zaragoza', 'El Tejar', 'San Juan Comalapa', 'San Pedro Yepocapa'
  ],
  'Chiquimula': [
    'Chiquimula', 'San José La Arada', 'San Juan Ermita', 'Jocotán',
    'Camotán', 'Olopa', 'Esquipulas', 'Concepción Las Minas', 'Quezaltepeque',
    'San Jacinto', 'Ipala'
  ],
  'El Progreso': [
  ...
  'Escuintla': [
    ...
    'Iztapa', 'Palín', 'San Vicente Pacaya', 'Nueva Concepción', 'Sipacate'
  ],
  'Guatemala': [
  ...
  'Huehuetenango': [
    ...
    'San Pedro Necta', 'Jacaltenango', 'Soloma', 'Ixcán', 'Santa Bárbara',
    ...
    'Aguacatán', 'San Rafael Pétzal', 'San Gaspar Ixchil', 'Santiago Chimaltenango',
  ...
  'Quetzaltenango': [
    ...
    'Cabricán', 'Cajolá', 'San Miguel Siguilá', 'Ostuncalco', 'San Mateo',
  ...
  'Quiché': [
    ...
    'Uspantán', 'Sacapulas', 'San Bartolomé Jocotenango', 'Canillá',
    'Chicamán', 'Ixcán', 'Pachalum', 'Playa Grande Ixcán'
  ],
  'Retalhuleu': [
  ...
  'Suchitepéquez': [
    ...
    'San Miguel Panán', 'San Gabriel', 'Chicacao', 'Patulul', 'Santa Bárbara',
...
// Verificar que tenemos 340 municipios
export function getTotalMunicipios(): number {
  return Object.values(municipiosPorDepartamento).reduce((total, municipios) => total + municipios.length, 0)
}
