...
var dist = __webpack_require__(709);
;// CONCATENATED MODULE: ./node_modules/@supabase/ssr/dist/module/utils/helpers.js
 ...
 */ const parse = (/* unused pure expression or super */ null && (cookieParse));
/**
 ...
 * `@supabase/ssr`.
 */ const serialize = (/* unused pure expression or super */ null && (cookieSerialize));
/**
...
function helpers_isBrowser() {
    return  false && 0;
} //# sourceMappingURL=helpers.js.map

;// CONCATENATED MODULE: ./node_modules/@supabase/ssr/dist/module/utils/constants.js
...
;// CONCATENATED MODULE: ./node_modules/@supabase/ssr/dist/module/utils/chunker.js
...
;// CONCATENATED MODULE: ./node_modules/@supabase/ssr/dist/module/utils/base64url.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@supabase/ssr/dist/module/utils/index.js



 //# sourceMappingURL=index.js.map

;// CONCATENATED MODULE: ./node_modules/@supabase/ssr/dist/module/cookies.js
 ...
 */ function cookies_createStorageFromOptions(options, isServerClient) {
    ...
    if (cookies) {
        ...
        setAll = (setCookies)=>{
            setCookies.forEach(({ name, value, options })=>{
                document.cookie = (0,dist/* serialize */.qC)(name, value, options);
            });
        };
    } else if (isServerClient) {
...
;// CONCATENATED MODULE: ./node_modules/@supabase/ssr/dist/module/createBrowserClient.js
...
const lib_helpers_isBrowser = ()=>"undefined" !== "undefined";
 ...
 * An array of characters that encode 6 bits into a Base64-URL alphabet
 * character.
 */ const base64url_TO_BASE64URL = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".split("");
/**
 * An array of characters that can appear in a Base64-URL encoded string but
 * should be ignored.
 */ const base64url_IGNORE_BASE64URL = " 	\n\r=".split("");
/**
 * An array of 128 numbers that map a Base64-URL character to 6 bits, or if -2
 * used to skip the character, or if -1 used to error out.
 */ const base64url_FROM_BASE64URL = (()=>{
    const charMap = new Array(128);
    for(let i = 0; i < charMap.length; i += 1){
        charMap[i] = -1;
    }
    for(let i = 0; i < base64url_IGNORE_BASE64URL.length; i += 1){
        charMap[base64url_IGNORE_BASE64URL[i].charCodeAt(0)] = -2;
    }
    for(let i = 0; i < base64url_TO_BASE64URL.length; i += 1){
        charMap[base64url_TO_BASE64URL[i].charCodeAt(0)] = i;
    }
    return charMap;
})();
/**
 ...
 */ function byteToBase64URL(byte, state, emit) {
    if (byte !== null) {
        ...
        while(state.queuedBits >= 6){
            ...
            emit(base64url_TO_BASE64URL[pos]);
            state.queuedBits -= 6;
        }
 ...
 */ function byteFromBase64URL(charCode, state, emit) {
    const bits = base64url_FROM_BASE64URL[charCode];
    if (bits > -1) {
        // valid Base64-URL character
 ...
 *
 * @param str The string to convert.
 */ function base64url_stringToBase64URL(str) {
    const base64 = [];
    const emitter = (char)=>{
        base64.push(char);
    };
    ...
    base64url_stringToUTF8(str, (byte)=>{
 ...
 *
 * @param str The Base64-URL encoded string.
 */ function base64url_stringFromBase64URL(str) {
    const conv = [];
    ...
    const byteEmit = (byte)=>{
        base64url_stringFromUTF8(byte, utf8State, utf8Emit);
    };
    for(let i = 0; i < str.length; i += 1){
 ...
 * @param codepoint The Unicode codepoint.
 * @param emit      Function which will be called for each UTF-8 byte that represents the codepoint.
 */ function base64url_codepointToUTF8(codepoint, emit) {
    if (codepoint <= 0x7f) {
        emit(codepoint);
        return;
    } else if (codepoint <= 0x7ff) {
 ...
 * @param str  The string to convert to UTF-8.
 * @param emit Function which will be called for each UTF-8 byte of the string.
 */ function base64url_stringToUTF8(str, emit) {
    for(let i = 0; i < str.length; i += 1){
        let codepoint = str.charCodeAt(i);
        if (codepoint > 0xd7ff && codepoint <= 0xdbff) {
            // most UTF-16 codepoints are Unicode codepoints, except values in this
        ...
        base64url_codepointToUTF8(codepoint, emit);
    }
}
/**
 * Converts a UTF-8 byte to a Unicode codepoint.
 ...
 *              sequence, an object with the shape `{ utf8seq: 0, codepoint: 0 }`.
 * @param emit  Function which will be called for each codepoint.
 */ function base64url_stringFromUTF8(byte, state, emit) {
    if (state.utf8seq === 0) {
        if (byte <= 0x7f) {
            emit(byte);
            return;
...
function stringToUint8Array(str) {
    const result = [];
    base64url_stringToUTF8(str, (byte)=>result.push(byte));
    return new Uint8Array(result);
} //# sourceMappingURL=base64url.js.map
...
const module_lib_helpers_isBrowser = ()=> false && 0;
 ...
 */ const supportsLocalStorage = ()=>{
    if (!module_lib_helpers_isBrowser()) {
        return false;
    }
    try {
...
function decodeJWT(token) {
    ...
    const data = {
        // using base64url lib
        header: JSON.parse(base64url_stringFromBase64URL(parts[0])),
        payload: JSON.parse(base64url_stringFromBase64URL(parts[1])),
...
class GoTrueClient {
     ...
     */ constructor(options){
        ...
        if (this.instanceID > 0 && module_lib_helpers_isBrowser()) {
        ...
        } else if (module_lib_helpers_isBrowser() && ((_a = globalThis === null || globalThis === void 0 ? void 0 : globalThis.navigator) === null || _a === void 0 ? void 0 : _a.locks)) {
        ...
        if (module_lib_helpers_isBrowser() && globalThis.BroadcastChannel && this.persistSession && this.storageKey) {
            try {
     ...
     */ async _initialize() {
        ...
        try {
             ...
             */ if (module_lib_helpers_isBrowser() && this.detectSessionInUrl && callbackUrlType !== "none") {
     ...
     */ async _getSessionFromURL(params, callbackUrlType) {
        try {
            if (!module_lib_helpers_isBrowser()) throw new AuthImplicitGrantRedirectError("No browser detected.");
     ...
     */ async linkIdentity(credentials) {
        ...
        try {
            ...
            if (error) throw error;
            if (module_lib_helpers_isBrowser() && !((_a = credentials.options) === null || _a === void 0 ? void 0 : _a.skipBrowserRedirect)) {
    ...
    async _handleProviderSignIn(provider, options) {
        ...
        if (module_lib_helpers_isBrowser() && !options.skipBrowserRedirect) {
     ...
     */ _removeVisibilityChangedCallback() {
        ...
        this.visibilityChangedCallback = null;
        try {
            if (callback && module_lib_helpers_isBrowser() && (window === null || window === void 0 ? void 0 : window.removeEventListener)) {
     ...
     */ async _handleVisibilityChange() {
        ...
        if (!module_lib_helpers_isBrowser() || !(window === null || window === void 0 ? void 0 : window.addEventListener)) {
...
;// CONCATENATED MODULE: ./node_modules/@supabase/ssr/dist/module/version.js
const version_VERSION = "0.6.1"; //# sourceMappingURL=version.js.map

;// CONCATENATED MODULE: ./node_modules/@supabase/ssr/dist/module/createServerClient.js
...
function createServerClient(supabaseUrl, supabaseKey, options) {
    ...
    const { storage, getAll, setAll, setItems, removedItems } = cookies_createStorageFromOptions({
        ...options,
        cookieEncoding: options?.cookieEncoding ?? "base64url"
    }, true);
    const client = module_createClient(supabaseUrl, supabaseKey, {
        ...options,
        global: {
            ...options?.global,
            headers: {
                ...options?.global?.headers,
                "X-Client-Info": `supabase-ssr/${version_VERSION} createServerClient`
            }
        },
        auth: {
            ...options?.cookieOptions?.name ? {
...
;// CONCATENATED MODULE: ./node_modules/@supabase/ssr/dist/module/index.js
...
async function middleware(request) {
    ...
    if (request.nextUrl.pathname.startsWith("/_next") || request.nextUrl.pathname.startsWith("/api") || request.nextUrl.pathname.startsWith("/static") || request.nextUrl.pathname.includes(".")) {
    ...
    const supabase = createServerClient("https://xcqdhrrphoksnzxuccht.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhjcWRocnJwaG9rc256eHVjY2h0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDM3MDM1MTAsImV4cCI6MjA1OTI3OTUxMH0.9yQf31FO8fJjY98o1PSv6xXnjEF4MJzT9BmzmKTc6Iw", {
        cookies: {
            get (name) {
